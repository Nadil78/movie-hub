...
<body>
    ...
    <section class="gallery">
        <h2>Top Seasonal Adventure Tv Shows</h2>
    ...
    <div class="movie-info">
        ...
        <p>Genre: Adventure | Rating: 7.6/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="mandalorian.jpg" alt="Mandalorian">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Mandalorian</h3>
        <p>Genre: Adventure | Rating: 7.4/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
    ...
    <div class="movie-info">
        ...
        <p>Genre: Adventure | Rating: 7.8/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="vikings.jpg" alt="Vikings">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Vikings</h3>
        <p>Genre: Adventure | Rating: 7.7/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
    ...
    <div class="movie-info">
        <h3>The Witcher</h3>
        <p>Genre: Adventure | Rating: 7.5/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="expanse.jpg" alt="The Expanse">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>The Expanse</h3>
...
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="lost.jpg" alt="Lost">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Lost</h3>
        <p>Genre: Adventure | Rating: 6.6/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="black sails.jpg" alt="Black Sails">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Black Sails</h3>
        <p>Genre: Adventure | Rating: 6.2/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
    ...
    <div class="movie-info">
        <h3>Arrow</h3>
        <p>Genre: Adventure | Rating: 5.9/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
    ...
    <div class="movie-info">
        <h3>Flash</h3>
        <p>Genre: Adventure | Rating: 5.8/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="outlander.jpg" alt="Brave the New World">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Brave the New World</h3>
        <p>Genre: Adventure | Rating: 7.6/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="super natural.jpg" alt="Super Natural">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Super Natural</h3>
...
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="prison break.jpg" alt="Prison Break">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Prison Break</h3>
...
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="umbrella academy.jpg" alt="Umbrella Academy">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
...
<head>
    ...
    background: url('portal.jpg') no-repeat center center fixed; 
