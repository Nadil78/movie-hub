...
<body>
    ...
    <section class="gallery">
        <h2>Top Seasonal Spine-chilling Tv Shows </h2>
        <div class="movie-grid">
            <!-- Movie Cards -->
            <div class="movie-card">
    <div class="movie-thumbnail">
        <img src="The Haunting of Hill House.jpg" alt="Haunting of Hill House">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Haunting of Hill House</h3>
        <p>Genre: Spine-Chilling | Rating: 7.5/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Black Mirror.jpg" alt="Black Mirror">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Black Mirror</h3>
        <p>Genre: Spine-Chilling | Rating: 7.8/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="The Exorcist tv.jpg" alt="Exorcist">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Exorcist</h3>
        <p>Genre: Spine-Chilling | Rating: 6.2/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Penny Dreadful.jpg" alt="Penny Dreadful">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Penny Dreadful</h3>
        <p>Genre: Spine-Chilling | Rating: 6.1/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Bates Motel.jpg" alt="Bates Motel">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Bates Motel</h3>
        <p>Genre: Spine-Chilling | Rating: 6.9/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Hannibal.jpg" alt="Hannibal">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Hannibal</h3>
        <p>Genre: Spine-Chilling | Rating: 7.6/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
    ...
    <div class="movie-info">
        <h3>The X Files</h3>
        <p>Genre: Spine-Chilling | Rating: 6.6/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Midnight Mass.jpg" alt="Midnight Mass">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Midnight Mass</h3>
...
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Castle Rock.jpg" alt="Castle Rock">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Castle Rock</h3>
        <p>Genre: Spine-Chilling | Rating: 5.9/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Channel Zero.jpg" alt="The Dream Door">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>The Dream Door</h3>
        <p>Genre: Spine-Chilling | Rating: 5.8/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="The Terror.jpg" alt="The Terror">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>The Terror</h3>
...
<div class="movie-card">
    ...
    <div class="movie-info">
        <h3>Marianne</h3>
        <p>Genre: Spine-Chilling | Rating: 7.4/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Servant.jpg" alt="Servant">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>Servant</h3>
...
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="The Outsider.jpg" alt="The Outsider">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
        <h3>The Outsider</h3>
        <p>Genre: Spine-Chilling | Rating: 7.7/10</p>
    </div>
</div>
<div class="movie-card">
    <div class="movie-thumbnail">
        <img src="Lovecraft Country.jpg" alt="Lovecraft Country">
        <button class="play-btn">&#9658;</button> <!-- Play Button -->
    </div>
    <div class="movie-info">
...
<head>
    ...
    background: url('art.jpg') no-repeat center center fixed; 
