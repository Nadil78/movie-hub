        ...
        <div class="movie-grid">
            ...
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="inception.jpg" alt="Scream 1">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Inception</h3>
                    <p>Genre: Action | Rating: 7.5/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="mad max.jpg" alt="Scream 2">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Mad Max</h3>
                    <p>Genre: Action | Rating: 7.8/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="john wick.jpg" alt="Scream 3">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>John Wick</h3>
                    <p>Genre: Action | Rating: 6.2/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="ambulance.jpg" alt="Scream 4">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Ambulance</h3>
                    <p>Genre: Action | Rating: 6.1/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="dark knight.jpg" alt="Scream 5">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Dark Knight</h3>
                    <p>Genre: Action | Rating: 6.9/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="tenet.jpg" alt="Saw 1">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Tenet</h3>
                    <p>Genre: Action | Rating: 7.6/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="red notice.jpg" alt="Saw 2">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Red Notice</h3>
                    <p>Genre: Action | Rating: 6.6/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="monkey man.jpg" alt="Saw 3">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Monkey Man</h3>
            ...
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="road house.jpg" alt="Saw 4">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Road House</h3>
                    <p>Genre: Action | Rating: 5.9/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="nobody.jpg" alt="Saw 5">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Nobody</h3>
                    <p>Genre: Action | Rating: 5.8/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="kingsman.jpg" alt="Harry Potter 1">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Kingsman</h3>
            ...
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="cherry.jpg" alt="Harry Potter 2">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Cherry</h3>
                    <p>Genre: Action | Rating: 7.4/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="hobbs and shows.jpg" alt="Harry Potter 3">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Hobbs and Shows</h3>
                    <p>Genre: Action | Rating: 7.8/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="top gun.jpg" alt="Harry Potter 4">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Top Gun</h3>
                    <p>Genre: Action | Rating: 7.7/10</p>
                </div>
            </div>
            <div class="movie-card">
                <div class="movie-thumbnail">
                    <img src="boy kills world.jpg" alt="Harry Potter 5">
                    <button class="play-btn">&#9658;</button> <!-- Play Button -->
                </div>
                <div class="movie-info">
                    <h3>Boy Kills World</h3>
                    <p>Genre: Action | Rating: 7.5/10</p>
                </div>
            </div>
...
<head>
    ...
    background: url('rock.jpg') no-repeat center center fixed; 
